...
IUSE="
	...
	+per-gov tickrate_perodic tickrate_idle +tickrate_full +preempt_full preempt_lazy preempt_voluntary preempt_none
	+o3 os debug +bbr3
...
REQUIRED_USE="
	...
	^^ ( preempt_full preempt_lazy preempt_voluntary preempt_none rt rt-bore )
	?? ( o3 os debug )
	^^ ( hugepage_always hugepage_madvise )
...
src_unpack() {
	...
	#   hardened sets stricter values (fifos=2,regular=2) and modifies the same context
	# 4567: Gentoo Kconfig additions shift mm/Kconfig line offsets, breaking hardened's
	#   DEFAULT_MMAP_MIN_ADDR hunk
...
# f7ce1a650782de6d35e9b7635dce828abde329b3
